...
#cta_engine.add_strategy('Class19FutureNeutralGridStrategy', 'class19', 'ethusdt.BINANCE', {})
#cta_engine.add_strategy('Class19FutureProfitGridStrategy', 'class19', 'ethusdt.BINANCE', {})
